  ...
  return (
    <div className="clinic-page">
      ...
      <main>
        ...
        <section
          id="especialista"
          className="clinic-doctor-section clinic-doctor-v2"
        >
          <div className="clinic-doctor-v2-grid">
            <Reveal className="clinic-doctor-v2-copy">
              <div className="clinic-eyebrow">
              ...
              <p className="clinic-doctor-v2-intro">
                Mais de 33 anos de experiência dedicados à medicina preventiva,
                nutrologia e investigação personalizada da saúde.
              </p>

              <p className="clinic-doctor-v2-description">
              ...
              <a
                className="clinic-button clinic-button-dark clinic-doctor-v2-button"
                href={siteData.whatsapp}
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <Reveal
              className="clinic-doctor-v2-visual"
              delay={120}
            >
              <div className="clinic-doctor-v2-image">
                <img
                  src={`${import.meta.env.BASE_URL}images/clinic/dr-maximo.jpg`}
                  alt="Dr. Maximo Asinelli"
                />

                <div className="clinic-doctor-v2-years">
                  <strong>+33</strong>
                  <span>anos de experiência</span>
                </div>

                <div className="clinic-doctor-v2-card">
                  <Stethoscope size={23} />

                  <div>
                    <strong>Medicina personalizada</strong>
                    <span>Ciência, experiência e cuidado individual.</span>
                  </div>
                </div>

                <div className="clinic-doctor-v2-register">
