...
const faqs = [
  {
    ...
    answer:
      "Tenha em mãos um documento oficial com foto e os documentos ou relatórios previamente solicitados. Nossa equipe confirma a lista completa no momento do agendamento.",
  },
  {
    question: "O resultado fica pronto no mesmo dia?",
    answer:
      "O prazo depende da categoria, das avaliações necessárias e da documentação apresentada. Em muitos casos, o processo pode ser concluído rapidamente.",
  },
  {
    question: "A clínica atende convênios ou planos de saúde?",
    answer:
      "As condições variam conforme o exame e o serviço realizado. Consulte nossa equipe para confirmar valores e possibilidades de atendimento.",
  },
  {
    question: "Posso realizar os exames no mesmo dia?",
    answer:
      "Sempre que a agenda e as avaliações necessárias permitirem, nossa equipe organiza o atendimento para concentrar as etapas no menor número possível de visitas.",
  },
  {
    question: "Quais são os horários de atendimento?",
    answer:
      "Atendemos de segunda a sexta-feira, das 08:30 às 12h e das 14h às 17h.",
  },
];
