  ...
  return (
    <div className="clinic-page">
      ...
      <main>
        ...
        <section
          id="especialista"
          className="clinic-doctor-v3"
        >
          <div className="clinic-doctor-v3-inner">
            <Reveal className="clinic-doctor-v3-copy">
              <div className="clinic-eyebrow">
              ...
              <div className="clinic-doctor-v3-tags">
              ...
              <a
                className="clinic-doctor-v3-button"
                href={siteData.whatsapp}
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <Reveal
              className="clinic-doctor-v3-visual"
              delay={120}
            >
              <div className="clinic-doctor-v3-image">
                <img
                  src={`${import.meta.env.BASE_URL}images/clinic/dr-maximo.jpg`}
                  alt="Dr. Maximo Asinelli"
                />

                <div className="clinic-doctor-v3-experience">
                  <strong>+33</strong>
                  <span>anos de experiência</span>
                </div>

                <div className="clinic-doctor-v3-info">
                  <Stethoscope size={24} />

                  <div>
                    <strong>Medicina personalizada</strong>
                    <span>
                      Ciência, experiência e cuidado individual.
                    </span>
                  </div>
                </div>

                <div className="clinic-doctor-v3-crm">
